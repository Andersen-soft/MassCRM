...
module.exports = {
  ...
  moduleNameMapper: {
    '\\.(svg)$': '<rootDir>/src/configs/svgMock.js',
    '\\.(css)$': '<rootDir>/src/configs/cssMock.js'
  },
  ...
  transform: {
    ...
    '^.+\\.(png|scss)$': '<rootDir>/src/configs/assetsTransformer.js'
  },
  ...
  setupFilesAfterEnv: ['<rootDir>/src/configs/testSetupFile.js']
};
