...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This URL Front-End site
    |
    */

    'front_end_url' => env('APP_URL_FRONT_END', 'http://localhost'),
    ...
    |--------------------------------------------------------------------------
    |
    | This URL SSO server authorization
    |
    */

    'sso_auth_server_url' => env('APP_URL_SSO_AUTH_SERVER', 'https://auth.andersenlab.com'),
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\Token\TymonTokenServiceProvider::class,
