...
class ReportRequest extends AbstractRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'search.sale_сreated' => 'array|size:2',
            'search.sale_сreated.min' => 'required_with:search.sale_сreated|date',
            'search.sale_сreated.max' =>
                'required_with:search.sale_сreated|date|after_or_equal:search.sale_сreated.min',
